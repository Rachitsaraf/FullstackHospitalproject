...
<section class="hero-banner-section" style="background-image: url('assets/images/banner-new.jpg');">
    ...
    <div class="container">
        <div class="hero-content text-center">
            <h1 class="page-title">Banded Gastric Bypass</h1>

            <ul class="modern-breadcrumb-list">
                <li><a href="<?php echo base_url(); ?>">Home</a></li>
                <li>Banded Gastric Bypass</li>
            </ul>
        </div>
    </div>
</section>
                ...
                <div class="blog-single-main-page">
                    <div class="blog-box p-0">
                        ...
                        <div class="video-wrapper mb-5"
                            ...
                            <iframe width="100%" height="340" src="https://www.youtube.com/embed/lbcoXomrOOQ"
                                title="Banded Gastric Bypass Procedure" frameborder="0"
                        ...
                        <div class="blog-content">
                            ...
                            <p style="margin-bottom: 22px; line-height: 1.8;">
                            ...
                            <p style="margin-bottom: 22px; line-height: 1.8;">
                                A gastrostomy tube may be inserted to keep the bypassed stomach compressed following
                                surgery; the gastrostomy site also has a marker to facilitate access for imaging and
                                other evaluations of the bypassed stomach if the need ever arises.
                            </p>
            ...
            <div class="col-lg-4 col-md-12">
                ...
                <div class="sidebar-card social-card">
                    ...
                    <ul class="social-links-list d-flex align-items-center">
                        <li>
                            <a href="https://www.facebook.com/IndiaObesity" target="_blank" aria-label="Facebook">
                                <i class="fab fa-facebook-f"></i>
                            </a>
                        </li>
                        <li>
                            <a href="https://x.com/mohakbariatrics" target="_blank" aria-label="Twitter">
                                <i class="fab fa-twitter"></i>
                            </a>
                        </li>
                        <li>
                            <a href="https://www.instagram.com/mohakbariatrics/" target="_blank" aria-label="Instagram">
                                <i class="fab fa-instagram"></i>
                            </a>
                        </li>
                        <li>
                            <a href="https://www.youtube.com/c/indiaobesity" target="_blank" aria-label="Youtube">
